...
namespace Akka.Streams.Msmq.Tests
{
    public class MsmqCoverageTests
    {
        ...
        public MsmqCoverageTests(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        [Fact]
        public void SendMessagesWithSingleTransactionsShouldFailed()
        {
            const string queuePath = @".\Private$\MsmqSpecQueue";
            EnsureQueueExists(queuePath);
        ...
        [Fact]
        public void ReceiveMessagesWithSingleTransactions()
        {
            const string queuePath = @".\Private$\MsmqSpecQueue";
            EnsureQueueExists(queuePath);
        ...
        public void ReceiveMessagesAsync()
        {
            ...
            try
            {
                ...
                using (var queue = new MessageQueue(queuePath, QueueAccessMode.Receive))
                {
                    ...
                    //var message = queue.Receive(TimeSpan.FromMilliseconds(10));
