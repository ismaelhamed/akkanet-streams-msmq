...
#pragma warning disable CA1033 // Interface methods should be callable by child types
        ...
        /// </summary>
        /// <value><c>true</c> if access to the <see cref="T:System.Collections.ICollection" /> is synchronized (thread safe); otherwise, <c>false</c>. In the default implementation of <see cref="T:Titanium.DlmsHE.TaskScheduling.CircularBuffer`1" />, this property always returns <c>false</c>.</value>
...
#pragma warning disable CA1033 // Interface methods should be callable by child types
        ...
        /// </summary>
        /// <value><c>true</c> if the <see cref="T:System.Collections.Generic.ICollection`1" /> is read-only; otherwise, <c>false</c>. In the default implementation of <see cref="T:Titanium.DlmsHE.TaskScheduling.CircularBuffer`1" />, this property always returns <c>false</c>.</value>
